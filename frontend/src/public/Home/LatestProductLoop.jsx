...
function LatestProductLoop({ value }) {
  ...
  const handleAddToWishlist = () => {
    axios
      .post(
        `${import.meta.env.VITE_API_URL}/wishlist/add/${value.id}`,
        {},
        {
          headers: {
  ...
  const handleRemoveFromWishlist = () => {
    axios
      .post(
        `${import.meta.env.VITE_API_URL}/wishlist/remove/${value.id}`,
        { _method: "delete" },
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  useEffect(() => {
    ...
    axios
      .get(`${import.meta.env.VITE_API_URL}/wishlist/check/${value.id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        withCredentials: true,
...
export default LatestProductLoop;
